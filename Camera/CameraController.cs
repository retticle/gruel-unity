...
#region Shake
	...
	private void ShakeOnDestroy() {
		if (_shakeCor != null) {
			RoutineRunner.StopRoutine(_shakeCor);
		}
	}

	public static void Shake(CameraShakeData _shakeData) {
		if (_instance._shakeCor != null) {
			RoutineRunner.StopRoutine(_instance._shakeCor);
		}

		_instance._shakeCor = RoutineRunner.StartRoutine(_instance.ShakeCor(_shakeData));
	}
