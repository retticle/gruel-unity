...
#region Music
	...
	public static void PlayMusic(MusicData musicData) {
		...
		if (_stopMusicCor != null) {
			RoutineRunner.StopRoutine(_stopMusicCor);
		}
	...
	public static void StopMusic() {
		...
		_stopMusicCor = RoutineRunner.StartRoutine(StopMusicCor());
	}
...
#region SFX
	...
	public static int PlaySFX(SFXData sfxData, float delay = 0.0f) {
		...
		// Start PlaySFXCor.
		_sfxRoutines[audioSourceId] = RoutineRunner.StartRoutine(PlaySFXCor(audioSourceId, sfxData, delay));
